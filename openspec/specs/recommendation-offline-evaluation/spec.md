# Recommendation Offline Evaluation Specification

## Purpose

Define reproducible zero-model-call evidence for recommendation quality through isolated public
short-video datasets, exact production replay, and blinded human Golden Sets.
