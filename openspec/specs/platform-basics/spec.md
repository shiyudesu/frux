...
Defines the baseline documentation and OpenSpec project structure for Frux: documentation entry points, engineering conventions, module documentation template, and OpenSpec project context that future spec-driven changes build on.
