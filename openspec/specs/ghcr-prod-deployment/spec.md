# ghcr-prod-deployment Specification

## Purpose

Defines CI-gated GHCR image publication, reviewer-protected production promotion, and safe server-side deployment and rollback.
