# production-moderation-provider Specification

## Purpose

Defines durable production moderation work, protected bounded inputs, authenticated provider exchange, conservative rollout controls, and safe human fallback.
