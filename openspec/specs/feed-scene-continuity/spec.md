# feed-scene-continuity Specification

## Purpose

Define in-memory continuity, isolation, invalidation, mutation coherence, and refresh behavior across Feed scenes.
