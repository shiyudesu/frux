# Session Semantic Acceptance Runner Specification

## Purpose

Define safe real-runtime orchestration and bounded evidence for dormant Session Semantic
Recommendation using pre-existing active-contract vectors and zero external model calls.
