# multimodal-video-discovery Specification

## Purpose

Defines exact multimodal retrieval, bounded semantic query embedding, deterministic hybrid search,
similar-video discovery, and the evidence required to enable those paths safely.
