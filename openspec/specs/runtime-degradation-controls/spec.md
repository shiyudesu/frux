# runtime-degradation-controls Specification

## Purpose

Define safe, registered, auditable runtime degradation controls that continue to behave predictably during control-plane failures.
