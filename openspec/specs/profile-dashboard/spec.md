...
The authenticated profile SHALL expose Works, Recommend, Likes, Favorites, Watch History, and Watch Later tabs backed by real data. The Works tab SHALL expose Published, Private Works, and Collections secondary views. Short Drama and Appointments tabs MUST NOT be rendered.
