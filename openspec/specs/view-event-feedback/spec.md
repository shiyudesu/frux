...
#### Scenario: Kafka does not acknowledge a view event
- **WHEN** Kafka publication fails or is uncertain
- **THEN** the outbox row remains pending and stable event IDs absorb retry duplicates
