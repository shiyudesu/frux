...
After the change is implemented and synchronized, active product source, configuration, documentation, tests, templates, filenames, and baseline specifications SHALL contain no legacy GCFeed product identifiers or `--gc-*` brand tokens.
