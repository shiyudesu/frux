...
- **WHEN** several fresh reinforcing positive signals have compatible vectors and limited
  contradiction
...
- **THEN** the Provider returns a deterministic bounded candidate prefix with `semantic_session`
  reason and finite positive confidence-scaled scores
