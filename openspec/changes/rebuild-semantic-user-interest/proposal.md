...
- Reads PostgreSQL source-of-truth facts and exact-model video embeddings; it adds no public API, Web behavior, semantic service calls, Redis or RabbitMQ workflow, online profile consumer, main-spec edit, or behavior change to current recommendation delivery.
