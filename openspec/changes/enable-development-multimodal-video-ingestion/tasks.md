...
- [ ] 4.1 Add focused config/env/Compose/runtime tests and run real PostgreSQL tests, `go test ./...`, entrypoint builds, Docker build, and strict OpenSpec validation.
- [ ] 4.2 Update README, embedding/recommendation/monitoring/product/roadmap documentation with the paid overlay command, cost boundary, rollback, and new-video semantics.
