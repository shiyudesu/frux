...
- [ ] 3.4 Add application/intake/leased-worker tests for disabled semantics, new and duplicate live events, changed text, hash or job-handoff failure, semantic success, closed semantic gate, invalid vectors, and concurrent idempotent writes.
