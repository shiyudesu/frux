...
var (
	...
	ErrInvalidMachineSource     = errors.New("invalid review machine source")
	ErrInvalidGeneratedAt       = errors.New("invalid review generation time")
	ErrInvalidModerationMode    = errors.New("invalid moderation rollout mode")
	ErrInvalidModerationJob     = errors.New("invalid moderation job")
	ErrModerationJobNotOwned    = errors.New("moderation job lease is not owned")
	ErrModerationJobStale       = errors.New("moderation job subject is stale")
	ErrInvalidModerationInput   = errors.New("invalid moderation input")
