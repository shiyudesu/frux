...
var ErrInvalidListQuery = errors.New("relation list query is invalid")
var ErrIdempotencyKeyTooLong = errors.New("idempotency key is too long")
var ErrFollowIdempotencyConflict = errors.New("follow idempotency key conflicts with a different state")
var ErrRecommendationRequestIDTooLong = errors.New("recommendation request id is too long")
var ErrInvalidRecommendationVideoID = errors.New("recommendation video id is invalid")
