...
type MessageModel struct {
	...
	UserID  int64  `gorm:"column:user_id;not null;index:idx_user_message_user_read_created,priority:1;uniqueIndex:uk_user_message_user_event,priority:1;uniqueIndex:uk_user_message_user_idempotency,priority:1"`
	...
	IdempotencyKey *string    `gorm:"column:idempotency_key;size:128;uniqueIndex:uk_user_message_user_idempotency,priority:2"`
	IsRead         bool       `gorm:"column:is_read;not null;default:false;index:idx_user_message_user_read_created,priority:2"`
	CreatedAt      time.Time  `gorm:"column:created_at;autoCreateTime;index:idx_user_message_user_read_created,priority:3;index:idx_user_message_user_created,priority:2"`
