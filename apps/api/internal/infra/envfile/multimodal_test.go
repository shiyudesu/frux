...
FRUX_MULTIMODAL_HYBRID_MIN_SIMILARITY=0.61
FRUX_MULTIMODAL_HYBRID_MAX_SEMANTIC_ONLY=4
...
`)
	...
	if os.Getenv("FRUX_MULTIMODAL_PROFILE") != "existing-profile" ||
		...
		os.Getenv("FRUX_MULTIMODAL_QUERY_EMBEDDING_ENABLED") != "true" ||
		os.Getenv("FRUX_MULTIMODAL_HYBRID_SEARCH_ENABLED") != "true" ||
		os.Getenv("FRUX_MULTIMODAL_HYBRID_MIN_SIMILARITY") != "0.61" ||
		os.Getenv("FRUX_MULTIMODAL_HYBRID_MAX_SEMANTIC_ONLY") != "4" ||
		os.Getenv("FRUX_MULTIMODAL_ALLOW_INSECURE_PRIVATE_NETWORK") != "true" ||
		...
		os.Getenv("FRUX_MULTIMODAL_SESSION_PRODUCTION_FULL_ROLLOUT_ENABLED") != "false" {
