...
| 视频 | 已实现 | 待审创建、批准/拒绝/下架/恢复生命周期、详情、可见性、创作者查询、批量操作、合集、对象存储和异步媒体处理 |
...
| 已实现 | 内容运营工作台 | typed `/admin/reviews`、`/admin/reviews/:reviewId`、`/admin/videos`；权限导航、审核租约/决定、视频下架/恢复和冲突恢复 |
| 规划中 | 监控看板 | 指标、告警和治理状态 |
