...
| `add-multimodal-acceptance-runner` | 已完成并通过真实 Runner 验收，待归档 | 默认无调用的验收计划、双重计费门禁、S3/审核/Job/Fact/Projection/Similar/Hybrid 编排与脱敏报告；真实链路已验证 2 次视频向量与 1 次查询向量调用，下一步进入真实 Golden Set 采集 |
